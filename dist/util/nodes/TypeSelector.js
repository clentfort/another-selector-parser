...
var TypeSelector = function (_SimpleSelector) {
  _inherits(TypeSelector, _SimpleSelector);

  function TypeSelector(value, namespacePrefix) {
    _classCallCheck(this, TypeSelector);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TypeSelector).call(this, 'TypeSelector'));
