...
var ClassSelector = function (_SimpleSelector) {
  _inherits(ClassSelector, _SimpleSelector);

  function ClassSelector(value) {
    _classCallCheck(this, ClassSelector);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClassSelector).call(this, 'ClassSelector'));
